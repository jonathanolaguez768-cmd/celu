const noMessages = [
  "¿Segura?😢",
  "Pero segura segura??😟",
  "Estas segurisimisima? 😞",
  "Na no te creo 😕",
  "Ya no te agas la dificil bluu 😩",
  "Di que siiii -_-",
  "Yaaa pinchi azulll",
  "Esto se va a repetir hasta que digas que si 😈",
];
let noIndex = 0;
...
function createOrbitHearts() {
  ...
  galaxy.innerHTML = `
    <div class="center-text" id="teAmo">
      Espero te guste este pequeño detalle que hice con mucho amor solo para ti bebe. Sabes que siempre estare aqui mi niña hermosa.<br> TODO SOLO PARA TI MI AZUL<br> Lit eres mi cielo🥰😘
    </div> `;
  const total = 140;
  const duration = 13;
  const emojis = ["🩷", "💙","💜","❤️"];
